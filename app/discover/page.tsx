...
import { type FragranceFilters, DEFAULT_FILTERS } from "@/lib/filters/types"

export default function DiscoverPage() {
  const { collection } = useLocker()
  const [filters, setFilters] = useState<FragranceFilters>(DEFAULT_FILTERS)
    ...
    <div className="space-y-12">
      ...
      <div className="text-center space-y-6 py-8">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Search our database or scan a perfume bottle to add it to your collection
        </p>
        {collection.length > 0 && (
          <div className="pt-4">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <FragranceSearch filters={filters} onFiltersChange={setFilters} />
        </div>
      </div>
    </div>
  )
